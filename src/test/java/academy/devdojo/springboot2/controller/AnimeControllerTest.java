...
class AnimeControllerTest {
    ...
    void findByName_ReturnsListOfAnime_whenSuccessfully() {
        ...
        List<Anime> anime = animeController.findByName("valid-name").getBody();
    ...
    void replace_UpdateAnime_whenSuccessfully() {
        ResponseEntity<Void> entity = animeController.replace(AnimePutRequestBodyCreator.animePutRequestBody());

        Assertions.assertThat(entity).isNotNull();
        Assertions.assertThat(entity.getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);
        Assertions.assertThatCode(() -> animeController.replace(AnimePutRequestBodyCreator.animePutRequestBody()))
